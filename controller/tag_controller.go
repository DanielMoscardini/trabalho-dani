...
// Cria nova tag de acordo com os dados forncecidos pela requisao JSON
...
// Atualiza a tag com base nos dados forncecidos pela requisao JSON
...
//  Exclui a tag com base no ID fornecido na solicitação
...
// Obtém uma tag com base no ID fornecido na solicitação 
